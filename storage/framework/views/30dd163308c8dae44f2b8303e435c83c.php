    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="sendRecoveryButton">Enviar</button>
            </div>
        </div>
    </div>
</div><?php /**PATH C:\xampp\htdocs\proyectoFinal\backoffice-administrador\resources\views/partials/forgot-password-modal.blade.php ENDPATH**/ ?>